...
export class RssService {
  ...
  async list(data: { term?: string; t?: string; q?: string; scanAllItems?: string | boolean; isScan?: string | boolean }) {
  ...
  async listAsXml(data: { term?: string; t?: string; q?: string; scanAllItems?: string | boolean; isScan?: string | boolean }) {
